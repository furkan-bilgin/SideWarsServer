...
namespace SideWarsServerTests
{
    ...
    public class RoomTests
    {
        ...
        public void CreateRoomWorks()
        {
            ...
            var player = new PlayerConnection(new Token(1, string.Empty, string.Empty, SideWars.Shared.Game.ChampionType.Hyrex, SideWars.Shared.Packets.EntityTeam.Blue), netPeer);
